...
const Skills = () => {
  return (
    <section id='skills'>
      ...
      <span className='skillDesc'>I'm a Denver native through and through. When I'm not immersed in coding challenges, you'll find me hitting the ski slopes or diving into the latest in gaming. My current top picks? Spider-Man 2, Valorant, and Baldur's Gate 3! Having been a gamer all my life, it was only a matter of time before the code came to me! I bring a friendly vibe and a hardworking attitude to every project. Wondering what I can bring to your business? Let me show you!</span>
      <div className='skillBars'>
        ...
        <div className='skillBar'>
          ...
          <div className='skillBarText'>
            <h2>Secure & Expansive Databases</h2>
